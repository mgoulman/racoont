...
function SignUpForm() {
  ...
  return (
    <form action="" onSubmit={handleRegister} id="sign-up-form">
      ...
      <br/> 
      <input type="email" name="email" id="email" onChange={(e) => setEmail(e.target.value)} vlaue={email} />
      <br/>
      ...
      <br/>
      <input type="password" name="password-conf" id="password-conf" onChange={(e) => setControlPasword(e.target.value)} value={controlPassword} />
      <br/>
      <div className="password-conf error"></div>
      <br/>
      <input type="checkbox" id="terms" />
      <label htmlFor='terms'>J'accept les <a href="/" target="_blank" rel="noopener noreferrer">Conditions</a></label>
